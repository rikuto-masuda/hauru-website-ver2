...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            <div className="space-y-8 text-lg md:mt-0 mt-8">
              <div className="border-l-4 border-blue-400 pl-6">
                <p className="text-gray-400 mb-1 text-sm">名前</p>
                <p className="text-2xl font-bold">はうる</p>
              </div>
              <div className="border-l-4 border-blue-400 pl-6">
                <p className="text-gray-400 mb-1 text-sm">所属</p>
                <p className="text-2xl font-bold">MONSTAR -xeno-</p>
              </div>
              <div className="border-l-4 border-blue-400 pl-6">
                <p className="text-gray-400 mb-1 text-sm">誕生日</p>
                {/* ここも誕生日を更新しておくね！ */}
                <p className="text-2xl font-bold">8月21日</p>
              </div>
              <div className="border-l-4 border-blue-400 pl-6">
                <p className="text-gray-400 mb-1 text-sm">血液型</p>
                <p className="text-2xl font-bold">A型</p>
              </div>
              <div className="border-l-4 border-blue-400 pl-6">
                <p className="text-gray-400 mb-1 text-sm">趣味</p>
